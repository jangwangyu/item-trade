...
public class ChatMessageService {
  ...
  // 메세지 전송
  public ChatMessageDto sendMessage(Long roomId, ChatMessageRequest request, Principal principal) {
    //사용자 존재하는지 확인
    String email = principal.getName();
    Member sender = memberRepository.findByEmail(email).orElseThrow(() ->
